...
function linkChannels(interaction, webid, activity_channel, combat_channel, admin_channel, report_channel, chat_channel, quest_channel, moneylog_channel, nesting_channel) {
    ...
    if (data) {
        ...
        const dataX = db.prepare(`INSERT INTO channels (guildId, webid, activity_channel, combat_channel, admin_channel, report_channel, chat_channel, quest_channel, moneylog_channel, nesting_channel) Values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);`).run(interaction.guildId, webid, activity_channel, combat_channel, admin_channel, report_channel, chat_channel, quest_channel, moneylog_channel, nesting_channel);
