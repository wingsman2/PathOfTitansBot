...
function addTokens(interaction, name, amount) {
    ...
    if (name.includes('@')) {
                    ...
                    if (dataG1) {
                        ...
                        interaction.reply({content: `${interaction.user} Added ${amount} ERA Coins to <@${name}>.`, ephemeral: false});
        ...
        if (name == 'self') {
            ...
            if (dataG1) {
                ...
                interaction.reply({content: `${interaction.user} Added ${amount} ERA Coins to your balance.`, ephemeral: false});
